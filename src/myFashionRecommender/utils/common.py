...
def read_yaml(path_to_yaml: Path) -> ConfigBox:
    ...
    except BoxValueError: # Here we are not using any custom exception, we are using the BoxValueError exception from the box library unlike logger which we have created ourselves
